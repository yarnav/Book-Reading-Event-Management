...
namespace Company.Project.Core.WebMVC.Filters
{
    public class ActionFilter : ActionFilterAttribute, IActionFilter
    {
        ...
        {
            ResourceManager rm = new ResourceManager("Company.Project.Core.WebMVC.ErrorResource",
                typeof(Company.Project.Core.WebMVC.ErrorResource).GetTypeInfo().Assembly);
